<div class="card shadow-sm border-0 mb-4">
    <div class="card-header bg-success text-white py-3">
        <h5 class="mb-0 fw-bold"><i class="bi bi-arrow-down-left-circle me-2"></i>Record Pay In (Money Received)</h5>
    </div>
    <div class="card-body">
        <form method="POST" action="<?php echo APP_URL; ?>/payments/payIn" id="paymentForm">
            <div class="row g-3">
                <div class="col-md-6">
                    <label class="form-label fw-bold">Received From (Party) <span class="text-danger">*</span></label>
                ...
                <div class="col-md-4">
                    <label class="form-label fw-bold">Amount Received (<?php echo cur_symbol(); ?>) <span class="text-danger">*</span></label>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="reference_number" class="form-control" placeholder="UTR / Txn ID">
                </div>
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="notes" class="form-control" placeholder="e.g. Cleared against outstanding balance">
                </div>
            </div>
            ...
            <div class="mt-4 p-3 bg-light rounded border d-flex justify-content-between align-items-center">
                <div>
                    <h6 class="mb-0 fw-bold text-dark"><i class="bi bi-link-45deg fs-5 text-primary me-1"></i>Link Payment to Transactions</h6>
                    <small class="text-muted">Allocate this received payment directly to open Tax Invoices.</small>
                </div>
                <button type="button" id="btnToggleLink" class="btn btn-outline-primary" disabled>
                    <i class="bi bi-receipt me-1"></i> Link Invoices
                </button>
            </div>

            <!-- Link Payment Table Section -->
            <div id="linkPaymentSection" class="mt-3 card border-primary d-none">
                <div class="card-header bg-primary bg-opacity-10 py-2 d-flex justify-content-between align-items-center">
                    <span class="fw-bold text-primary"><i class="bi bi-list-check me-1"></i> Open Tax Invoices for <span id="selectedPartyName" class="text-dark"></span></span>
                    <span class="badge bg-primary">Received: <?php echo cur_symbol(); ?><span id="displayRecAmount">0.00</span></span>
                </div>
            ...
            <div class="mt-4 text-end">
                ...
                <button type="submit" class="btn btn-success px-4"><i class="bi bi-check-circle"></i> Save Pay-In</button>
            </div>
        </form>
    </div>
</div>
        ...
        fetch('<?php echo APP_URL; ?>/payments/getPartyInvoicesAjax/' + partyId)
            ...
            .then(invoices => {
                ...
                if (!invoices || invoices.length === 0) {
                    invoicesBody.innerHTML = '<tr><td colspan="7" class="text-center py-3 text-muted">No unpaid tax invoices found for this party.</td></tr>';
                    return;
                }
